...
var tags=['a','div','span','p','img','input','var','if','spd','next','keep','skip','bg','color','lh','audio','nskp','reset'];
var tf={next:snext,keep:skeep,skip:sskip,spd:sspd,color:scolor,lh:slh,var:svar,if:sif,bg:sbg,img:simg,input:sinput,audio:saudio,a:stag,span:stag,div:stag,p:stag,nskp:snskp};
var nextA=false;
var nextP=null;
var ant;
