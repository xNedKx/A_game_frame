...
//
/*tit=[
'<div style="text-align:center;font-size:3em;font-weight:nold;">測　試　展　示　程　式</div>',//title
'[開始]',//start button
''//preload image page
];*/
//
...
'<skip /><var n="n" v=rnd /><var n="n" v="*5" /><var n="na" v="王大同" /><if n="n" c="ME" v="1"><var n="na" v="林小明" /><if n="n" c="ME" v="2"><var n="na" v="吳鳴世" /><if n="n" c="ME" v="3"><var n="na" v="秋森萬" /><if n="n" c="ME" v="4"><var n="na" v="艾隆麵" /></if></if></if></if><div>該怎麼稱呼您呢？ <input n="name" maxL=12 v=na /><if n="na" c="E" v=name gt=1 /><div style="float:right;"><a gt=1>[換個名子看看]</a><a gt>[確認]</a></div><div style="clear:both"></div></div>',
